...
[CreateAssetMenu(fileName = "MeshGenerator", menuName = "Scriptable Objects/MeshGenerator")]
public class MeshGeneratorSO : ScriptableObject {

	// Editor

	#if UNITY_EDITOR
	[CustomEditor(typeof(MeshGeneratorSO))]
	class MeshGeneratorSOEditor : EditorExtensions {
		MeshGeneratorSO I => target as MeshGeneratorSO;
